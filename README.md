...
infected patients. \#\#\# Required data can can be downloaded by the
link: <https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE139522>
\#\#\# To have a look on figures with code,you can download html file
link given below.
